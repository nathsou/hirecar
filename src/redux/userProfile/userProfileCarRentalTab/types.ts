...
export type UserProfileCarRentalsActionTypes = UserProfileCarRentalsSentAction | UserProfileCarRentalsReceivedAction | DeleteUserProfileCarRentalAction | CancelDeleteUserProfileCarRentalAction | DeleteUserProfileCarRentalSentAction | DeleteUserProfileCarRentalReceivedAction | ToggleModalAction;
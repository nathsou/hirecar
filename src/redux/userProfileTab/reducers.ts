import { UserProfileActionTypes, UPDATE_USER_PROFILE_FIRSTNAME_INPUT, UserProfileTabState, defaultUserProfileTabState, SET_USER_PROFILE, UPDATE_USER_PROFILE_LASTNAME_INPUT, UPDATE_USER_PROFILE_EMAIL_INPUT, UPDATE_USER_PROFILE_PHONE_INPUT, SUMBIT_USER_PROFILE, USER_PROFILE_FORM_SENT, USER_PROFILE_FORM_RECEIVED, UPDATE_USER_PROFILE_NEW_PASSWORD_INPUT, UPDATE_USER_PROFILE_CONFIRM_NEW_PASSWORD_INPUT, USER_PROFILE_SAVED } from "./types";
